...
const Hero = () => {
    ...
    return (
        <HeroBanner bgStyle={'bg-[url("/assets/images/about.jpg")] md:!h-[60vh] !h-[50vh] bg-bottom'}>
            <div className='h-full sm:mt-10 flex items-center'>
                <div className='w-full z-30 flex  items-center  justify-center relative'>
                    <Heading className={'text-white z-30 text-center font-semibold w-full'}>About Us</Heading>
                </div>
            </div>
